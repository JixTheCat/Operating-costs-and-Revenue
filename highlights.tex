...
\item We link key factors that determinine vineyard operational costs and revenue through the use of XGBoost.

\item We illustrate the interrelated nature of vineyard's factors and the comparative influence they have on one another.

\item We connect variables to different wine regions, highlighting the complex influence of location on the use of different resources.
